...
import FuseLayoutConfigs from '@/@business_saas/core/FuseSettings/FuseLayoutConfigs';
import usePrevious from '@/@business_saas/hooks/usePrevious';
import PaletteSelector from './palette-generator/PaletteSelector';
import SectionPreview from './palette-generator/SectionPreview';

/**
 * The Root styled component is used to style the root div of the BSSettings component.
...
export type BSThemeType = { palette: PartialDeep<Palette> };
export type BSThemesType = Record<string, BSThemeType>;
export type FuseSettingsConfigType = {
    layout: { style?: string; config?: PartialDeep<themeLayoutDefaultsProps> };
    customScrollbars?: boolean;
    direction: 'rtl' | 'ltr';
    theme: { main: BSThemeType; navbar: BSThemeType; toolbar: BSThemeType; footer: BSThemeType };
    defaultAuth?: string[];
    loginRedirectUrl: string;
};

type BSSettingsProps = {
 ...
 */
function FuseSettings(props: BSSettingsProps) {
