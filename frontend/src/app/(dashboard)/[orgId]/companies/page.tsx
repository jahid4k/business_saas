                        ...
                        {confirming ? (
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            <button
                              ...
                              className="flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium text-(--text-secondary) border border-(--border) hover:bg-(--bg-surface) transition-colors"
                            >
                              <Users size={12} />
                              Contacts
                            </button>
