          ...
          <div ref={listRef} className="space-y-1.5">
            {filtered.map((dept) => {
              ...
              return (
                <div
                  key={dept.id}
                  className="dept-row group relative flex items-start gap-3.5 px-4 py-3.5 rounded-xl bg-[var(--bg-surface)] border border-[var(--border)] hover:border-[var(--text-muted)]/25 transition-all duration-150"
                >
