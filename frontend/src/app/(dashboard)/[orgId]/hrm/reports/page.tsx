...
export default function HRMReportsPage({
  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl">
      ...
      {isLoading ? (
        <div className="flex items-center justify-center py-24 text-sm text-[var(--text-muted)] gap-3">
        ...
        <>
          ...
          {/* Secondary stats */}
          <div className="flex items-center gap-5 mb-6 text-xs text-[var(--text-muted)] flex-wrap">
          ...
          <div className="rounded-xl bg-[var(--bg-surface)] border border-[var(--border)] overflow-hidden">
            <p className="text-sm font-semibold text-[var(--text-primary)] px-4 pt-4 pb-3">
              Leave summary detail
            </p>
            {leaveSummary.length === 0 ? (
              <p className="text-xs text-[var(--text-muted)] px-4 pb-4">
