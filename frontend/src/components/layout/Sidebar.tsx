  ...
  return [
    ...
    },
    {
      ...
      items: [
        {
          label: "Employees",
          href: `/${orgId}/hrm/employees`,
          icon: UserRound,
          permission: "hrm.employees.view",
        },
        {
          label: "Leave",
          href: `/${orgId}/hrm/leave`,
          icon: CalendarDays,
          permission: "hrm.leave.view",
        },
        {
          label: "Lifecycle",
          href: `/${orgId}/hrm/lifecycle`,
          icon: ArrowRightLeft,
          permission: "hrm.promotions.view",
        },
        {
          label: "Attendance",
          href: `/${orgId}/hrm/attendance`,
          icon: Clock,
          permission: "hrm.attendance.view",
        },
        {
          label: "Compliance",
          href: `/${orgId}/hrm/compliance`,
          icon: ShieldAlert,
          permission: "hrm.complaints.view",
        },
        {
          label: "Recognition",
          href: `/${orgId}/hrm/recognition`,
          icon: PartyPopper,
